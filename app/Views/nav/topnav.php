...
<div class="header">
    ...
    <div class="header-left active">
        <a href="<?php echo base_url('/'); ?>" class="logo logo-normal d-flex align-items-center">
            <img src="<?php echo base_url('assets/img/authentication/deccan_logo.png') ?>" alt="Deccen Clap Logo">
        </a>
                ...
                <a href="javascript:void(0);" class="nav-link userset" data-bs-toggle="dropdown">
                    <span class="user-info">
                        <span class="user-letter">
                            ...
                            <img src="<?php echo base_url('assets/images/profile/'.session()->get('image'));?>" alt="Profile">
                            <?php } else { ?>
                            <img src="<?php echo base_url('assets/img/authentication/deccen_logo1.jpg'); ?>" alt="Profile">
                            <?php }?>
                        </span>
