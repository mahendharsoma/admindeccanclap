					...
					<div class="row align-items-center">
						...
						<div class="col-4 text-end">
							<div class="head-icons">
								<a href="<?= base_url('super_admins'); ?>" data-bs-toggle="tooltip" data-bs-placement="top"
							...
							<div class="col-sm-8">
								<div
									...
									<a href="javascript:void(0);" class="btn btn-primary"
										data-bs-toggle="offcanvas" data-bs-target="#createSuperAdmin"><i
											class="ti ti-square-rounded-plus me-2"></i>Create Super admin</a>
								</div>
							</div>
						</div>
						<!-- /Search -->
					...
					<div class="card-body">
						...
						<div class="table-responsive custom-table">
							<table class="table">
								...
								<tbody>
									<?php if (isset($super_admin_data) && !empty($super_admin_data)) {
										$i = 1; foreach ($super_admin_data as $user_details) { ?>
									<tr>
										<td><?php echo $i++; ?></td>
										<td>
											...
											<div class="dropdown table-action">
												...
												<div class="dropdown-menu dropdown-menu-right">
													<a class="edit_value dropdown-item" type="button"
														data_id="<?php echo deccan_encode($user_details['user_id']); ?>"
                                                        data_url="<?php echo base_url('ajax_get_edit_super_admin_details'); ?>"
...
<!-- Add User -->
<div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="createSuperAdmin">
	<div class="offcanvas-header border-bottom">
		<h5 class="fw-semibold">Create Super Admin</h5>
		<button type="button"
	...
	<div class="offcanvas-body">
		<form id="generic_form" action="<?php echo base_url('ajax_add_super_admin'); ?>" method="post">
			<div>
				<!-- Basic Info -->
				<div>
					<div class="row">
...
<div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="editSuperAdminModel">
	...
	<div class="offcanvas-body">
		<form id="generic_form" action="<?php echo base_url('ajax_update_super_admin') ?>" method="post">
			<div>
				<!-- Basic Info -->
				<div id="row">
					<div class="col-md-12">
