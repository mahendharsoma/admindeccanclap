			...
			<div class="col-md-12">
				...
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col-8">
							<h4 class="page-title">Inside Sales Executives</h4>
						</div>
						<div class="col-4 text-end">
							<div class="head-icons">
								<a href="<?= base_url('inside_sales_executives'); ?>" data-bs-toggle="tooltip" data-bs-placement="top"
				...
				<div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 p-2">
                                <div class="mb-3">
                                    <div class="icon-form mb-3 mb-sm-0">
                                        <h4>Select Sales Manager</h4>
                                    </div>
                                </div>
                                <select class="form-control select2jsMultiSelect select2" onchange="route_value_two_redirect(this);">
                                    <option value="" selected disabled>Select Sales Manager</option>
                                    <?php if($sales_managers_data) { ?>
                                    <?php foreach($sales_managers_data as $sales_manager_det) { ?>
                                    <option value="<?php echo deccan_encode($sales_manager_det['user_id']) ;?>"
                                    <?php if (isset($selected_sales_manager_id) && $selected_sales_manager_id == $sales_manager_det['user_id'])
                                                {
                                                    echo 'selected';
                                                }
                                                ?>><?php echo $sales_manager_det['user_name']; ?></option>
                                    <?php } }?>
                                </select>  
                            </div>
                            <?php } ?>
                    ...
                    <?php if(!empty($selected_parent_id) && !empty($selected_sales_manager_id)) { ?>
                                ...
                                <div class="col-sm-8">
                                    <div
                                        ...
                                        <a href="javascript:void(0);" class="btn btn-primary"
                                            data-bs-toggle="offcanvas" data-bs-target="#createInsideSalesExecutive"><i
                                                class="ti ti-square-rounded-plus me-2"></i>Create Inside Sales Executive</a>
                                    </div>
                                </div>
                            </div>
                            <!-- /Search -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive custom-table">
                                <table class="table bell_of_arms_table">
                                    ...
                                    <tbody>
                                        <?php if (isset($inside_sales_executives_data) && !empty($inside_sales_executives_data)) {
                                            $i = 1; foreach ($inside_sales_executives_data as $user_details) { ?>
                                        <tr>
                                            <td><?php echo $i++; ?></td>
                                            <td>
                                                ...
                                                <div class="dropdown table-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="edit_value dropdown-item" type="button"
                                                            data_id="<?php echo deccan_encode($user_details['user_id']); ?>"
                                                            data_url="<?php echo base_url('ajax_get_edit_inside_sales_executive_details'); ?>"
...
<!-- Add User -->
<div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="createInsideSalesExecutive">
	...
	<div class="offcanvas-body">
		<form id="generic_form" action="<?php echo base_url('ajax_add_inside_sales_executive'); ?>" method="post">
			<div>
                <!-- Basic Info -->
                <div>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="hidden" class="form-control" name="parent_id" value="<?= isset($selected_sales_manager_id) && !empty($selected_sales_manager_id) ? deccan_encode($selected_sales_manager_id) : '' ?>">
                            </div>
                        </div>
...
<div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="editUserModel">
	...
	<div class="offcanvas-body">
		<form id="generic_form" action="<?php echo base_url('ajax_update_inside_sales_executive') ?>" method="post">
			<div>
				<!-- Basic Info -->
				<div id="row">
					<div class="col-md-12">
