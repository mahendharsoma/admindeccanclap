		...
		<div class="row">
			<div class="col-md-12">
					...
					<div class="row align-items-center">
						...
						<div class="col-4 text-end">
							<div class="head-icons">
								<a href="<?= base_url('vendors'); ?>" data-bs-toggle="tooltip" data-bs-placement="top"
				...
				<div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 p-2">
                                <div class="mb-3">
                                    <div class="icon-form mb-3 mb-sm-0">
                                        <h4>Select Vendor Manager</h4>
                                    </div>
                                </div>
                                <select class="form-control select2jsMultiSelect select2" onchange="route_value_two_redirect(this);">
                                    <option value="" selected disabled>Select Vendor Manager</option>
                                    <?php if($vendor_managers_data) { ?>
                                    <?php foreach($vendor_managers_data as $vendor_manager_det) { ?>
                                    <option value="<?php echo deccan_encode($vendor_manager_det['user_id']) ;?>"
                                    <?php if (isset($selected_vendor_manager_id) && $selected_vendor_manager_id == $vendor_manager_det['user_id'])
                                                {
                                                    echo 'selected';
                                                }
                                                ?>><?php echo $vendor_manager_det['user_name']; ?></option>
                                    <?php } }?>
                                </select>  
                            </div>
                            <?php } ?>
                    ...
                    <?php if(!empty($selected_parent_id) && !empty($selected_vendor_manager_id)) { ?>
                                    ...
                                    <div
                                        ...
                                        <a href="javascript:void(0);" class="btn btn-primary"
                                            data-bs-toggle="offcanvas" data-bs-target="#createUserMode"><i
                                                class="ti ti-square-rounded-plus me-2"></i>Create Vendor</a>
                                    </div>
                                </div>
                            </div>
                            <!-- /Search -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive custom-table">
                                <table class="table bell_of_arms_table">
                                    ...
                                    <tbody>
                                        <?php if (isset($vendors_data) && !empty($vendors_data)) {
                                            $i = 1; foreach ($vendors_data as $user_details) { ?>
                                        <tr>
                                            <td><?php echo $i++; ?></td>
                                            <td>
                                                ...
                                                <div class="dropdown table-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="edit_value dropdown-item" type="button"
                                                            data_id="<?php echo deccan_encode($user_details['user_id']); ?>"
                                                            data_url="<?php echo base_url('ajax_get_edit_vendor_details'); ?>"
...
<div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="createUserMode">
	<div class="offcanvas-header border-bottom">
		<h5 class="fw-semibold">Create New Vendor</h5>
		<button type="button"
	...
	<div class="offcanvas-body">
		<form id="generic_form" action="<?php echo base_url('ajax_add_vendor'); ?>" method="post">
			<div>
                <!-- Basic Info -->
                <div>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="hidden" class="form-control" name="parent_id" value="<?= isset($selected_vendor_manager_id) && !empty($selected_vendor_manager_id) ? deccan_encode($selected_vendor_manager_id) : '' ?>">
                            </div>
                        </div>
...
<div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="editUserModel">
	...
	<div class="offcanvas-body">
		<form id="generic_form" action="<?php echo base_url('ajax_update_vendor') ?>" method="post">
			<div>
				<!-- Basic Info -->
				<div id="row">
					<div class="col-md-12">
