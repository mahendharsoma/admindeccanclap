			...
			<div class="col-md-12">
				...
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col-8">
							<h4 class="page-title">Field Sales Executives</h4>
						</div>
						<div class="col-4 text-end">
							<div class="head-icons">
								<a href="<?= base_url('field_sales_executives'); ?>" data-bs-toggle="tooltip" data-bs-placement="top"
				...
				<div class="card">
                    ...
                    <?php if(!empty($selected_sales_manager_id) && !empty($selected_sales_manager_id)) { ?>
                        <div class="card-header">
                            <!-- Search -->
                            <div class="row align-items-center">
                                <div class="col-sm-4">
                                    <div class="icon-form mb-3 mb-sm-0">
                                        <h4>Field Sales Executives</h4>
                                    </div>
                                </div>
                                <div class="col-sm-8">
                                    <div
                                        ...
                                        <a href="javascript:void(0);" class="btn btn-primary"
                                            data-bs-toggle="offcanvas" data-bs-target="#createUserMode"><i
                                                class="ti ti-square-rounded-plus me-2"></i>Create Field Sales Executive</a>
                                    </div>
                                </div>
                            </div>
                            <!-- /Search -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive custom-table">
                                <table class="table bell_of_arms_table">
                                    ...
                                    <tbody>
                                        <?php if (isset($field_sales_executives_data) && !empty($field_sales_executives_data)) {
                                            $i = 1; foreach ($field_sales_executives_data as $user_details) { ?>
                                        <tr>
                                            <td><?php echo $i++; ?></td>
                                            <td>
                                                ...
                                                <div class="dropdown table-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="edit_value dropdown-item" type="button"
                                                            data_id="<?php echo deccan_encode($user_details['user_id']); ?>"
                                                            data_url="<?php echo base_url('ajax_get_edit_field_sales_executive_details'); ?>"
...
<div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="createUserMode">
	...
	<div class="offcanvas-body">
		<form id="generic_form" action="<?php echo base_url('ajax_add_field_sales_executive'); ?>" method="post">
			<div>
                <!-- Basic Info -->
                <div>
                    <div class="row">
...
<div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="editUserModel">
	...
	<div class="offcanvas-body">
		<form id="generic_form" action="<?php echo base_url('ajax_update_field_sales_executive') ?>" method="post">
			<div>
				<!-- Basic Info -->
				<div id="row">
					<div class="col-md-12">
