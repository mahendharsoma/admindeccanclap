                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                                ...
                                                <td class="text-end">
                                                    <div class="dropdown table-action">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="<?php echo base_url('audio_call'); ?>"><i class="ti ti-phone text-success"></i> Call</a>
                                                            <a class="dropdown-item" href="<?php echo base_url('call_history'); ?>"><i class="ti ti-phone text-info"></i> Call History</a>
                                            ...
                                            <tr>
                                                ...
                                                <td>Collins</td>
                                                <td>+1 875455453</td>
                                                <td>collins@example.com</td>
                                                <td>Newyork, USA</td>
                                                <td>25 Sep 2023, 01:22 pm</td>
                                                <td>Paid Social</td>
                                                ...
                                                <td class="text-end">
                                                    <div class="dropdown table-action">
                                                        <a href="#" class="action-icon" data-bs-toggle="dropdown"><i class="fa fa-ellipsis-v"></i></a>
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item"><i class="ti ti-phone text-success"></i> Call</a>
                                                            <a class="dropdown-item"><i class="ti ti-phone text-info"></i> Call History</a>
                                                            <a class="dropdown-item" data-bs-toggle="offcanvas" data-bs-target="#offcanvas_edit"><i class="ti ti-edit text-blue"></i> Update</a>
                                                        </div>
                                                    </div>
                                                </td>
