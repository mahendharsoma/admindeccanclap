...
class Sales_Manager_Control extends Default_Controller
{
	...
	public function index($seg1 = false)
	{
	    ...
	    return $this->generateView('content_panel/User_Management/sales_managers_view',$data);
	}

    public function ajax_add_sales_manager()
    {
        // --------------------- VALIDATION ---------------------
        $rules = [
        ...
        $this->ajax_success_response("Successfully Created Sales Manager!", array(),"Yes");
    }


    public function ajax_get_edit_sales_manager_details()
    {
        ...
        // var_dump($user_doc_details_result); exit;
    ...
    // public function ajax_update_sales_manager()
    // {
    //    $rules = [
    //         'user_name' => ['label' => 'User Name', 'rules' => 'required'],
    //         'email_id' => ['label' => 'Email ID', 'rules' => 'required'],
    ...
    //     $this->ajax_success_response('Successfully Sales Manager data updated!', array(), 'Yes');
    //     return;
    // }
