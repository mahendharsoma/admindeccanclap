...
class Vendor_Managers_Control extends Default_Controller
{
	...
	public function index($seg1 = false)
	{
	    ...
	    return $this->generateView('content_panel/User_Management/vendor_managers_view',$data);
	}

    public function ajax_add_vendor_manager()
    {
       // --------------------- VALIDATION ---------------------
        $rules = [
        ...
        $this->ajax_success_response('Successfully Created Vendor Manager!', array(), 'Yes');
        return;
    }

    public function ajax_get_edit_vendor_manager_details()
    {
    ...
    public function ajax_update_vendor_manager()
    {
       $rules = [
            'user_name'        => ['label' => 'User Name', 'rules' => 'required'],
            'email_id'         => ['label' => 'Email ID', 'rules' => 'required'],
        ...
        ---------------------------------------------------------- */
        $this->db->transComplete();
        $this->ajax_success_response('Successfully Vendor Manager data updated!', array(), 'Yes');
        return;
    }
